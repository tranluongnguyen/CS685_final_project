...
model_path = "/content/drive/MyDrive/Cs685/weights/xlsum_en/ckpt_best_xlsum_en_standard.pt"
embed_path = "/content/drive/MyDrive/Cs685/weights/vietnamese/only_embed_adapt_vietnamese_noise.pt"
# model_path = "/content/drive/MyDrive/personalized_text_gen/scholary/weights/xlsum_en/ckpt_best_xlsum_en_af.pt"
...
evaluate_xlsum(lang='vietnamese', pred_file='xlsum_af_std_predict.txt', gold_file='xlsum_vi.pkl')
# evaluate_xlsum(lang='vietnamese', pred_file='xlsum_af_af_predict.txt', gold_file='xlsum_vi.pkl')
