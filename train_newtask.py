...
out_dir = f"out/newtask_{dataset}_{type_pretrain}"
...
def NewTaskModel(model):
    ...
    # NOTE freeze token
    token_modules = [model.transformer.wte, model.transformer.wpe]
    for m in token_modules:
